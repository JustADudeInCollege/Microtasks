...
declare module "$app/types" {
	export interface AppTypes {
		RouteId(): "/" | "/ai-chat" | "/api" | "/api/auth" | "/api/auth/session" | "/api/chats" | "/api/chat" | "/api/cron" | "/api/cron/send-reminders" | "/api/notifications" | "/api/pase-task-nlp" | "/api/v1" | "/api/v1/chat" | "/api/workspace" | "/api/workspace/activity" | "/api/workspace/assignments" | "/api/workspace/invitations" | "/api/workspace/members" | "/api/workspace/share-link" | "/calendar" | "/dashboard" | "/forgotpass" | "/home" | "/join" | "/join/[token]" | "/kanban" | "/login" | "/settings" | "/signup" | "/support" | "/tasks" | "/workspace" | "/workspace/[boardId]";
		RouteParams(): {
